...
for i, width in enumerate(widths):
    ...
    betas1 = get_betas_from_dimensions(thick, width)
    betas2 = get_betas_from_dimensions(thick, width + deltaW)
    ...
    beta = fiber2.Beta2(pulse) * 1e3  # convert ps^2/m to ps^2/km
    
    # Plot the dispersion in the bottom panels
    axs0[2,i].plot(F[W > 0], beta[W > 0],       color='g', ls='dashed')

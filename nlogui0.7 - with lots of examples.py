...
ax13 = plt.axes([sl, sv+16*ss, sw, sh])
ax14 = plt.axes([sl, sv+17*ss, sw, sh])
...
bScale = Button(ax13, 'Rescale plots')
bCalc  = Button(ax14, 'Calc Dispersion')
bRun   = Button(ax15, 'Run Simulation')
